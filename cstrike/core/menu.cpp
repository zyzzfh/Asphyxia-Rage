...
void MENU::RenderMainWindow()
{
	...
	// render main window
	ImGui::Begin(CS_XOR("Joeware Recode"), &bMainWindowOpened, ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse | ImGuiWindowFlags_NoCollapse);
	{
...
void MENU::RenderWatermark()
{
	...
	ImGui::BeginMainMenuBar();
	{
		...
		static ImVec2 vecNameSize = ImGui::CalcTextSize(CS_XOR("joeware | " __DATE__ " " __TIME__));
		...
		ImGui::TextColored(ImVec4(1.0f, 1.0f, 1.0f, 1.0f), CS_XOR("joeware | " __DATE__ " " __TIME__));
	}
